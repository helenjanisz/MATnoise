...
parameters.ccfpath = '/Users/noah/AACES_Data_09_10_2018/XO_sps25_test2/ccf_test2/';
parameters.figpath = [parameters.workingdir,'figs/'];
parameters.seis_path = [parameters.workingdir,'seismograms/'];
parameters.orientation_path = '/Users/noah/Github/MATnoise/OBS_Orientaion_Test2.txt'; % Column 1: station name;   Column 2: H1 degrees CW from N
[stalist, stalat, stalon, staz] = textread(['/Users/noah/Github/MATnoise/Stalist_Test2.txt'],'%s %f %f %f\n');
